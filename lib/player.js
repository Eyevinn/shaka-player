...
/**
 * @event shaka.Player.SegmentLoadedEvent
 * @description Fired once a segment has been downloaded
 * @property {string} type
 *   'segmentloaded'
 * @property {shakaExtern.SegmentLoadedInfo} detail
 *   An object which contains a description of loaded segment.
 * @exportDoc
 */


/**
 * @event shaka.Player.SourceBufferInitiatedEvent
 * @description Fired once the Media Source Buffer has been initiated
 * @property {string} type
 *   'sourcebufferinitiated'
 * @property {shakaExtern.SourceBufferInfo} detail
 *   An object which contains a description of the initiated source buffer.
 * @exportDoc
 */
