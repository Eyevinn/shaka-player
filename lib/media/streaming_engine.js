 ...
 * @private
 */
shaka.media.StreamingEngine.ClearBufferType_ = {
  NONE: 0,
  FLUSH: 1,
  NOFLUSH: 2
};
 ...
 * @property {Object} waitingToClearBuffer
 ...
 * @private
 */
shaka.media.StreamingEngine.prototype.clear_ = function(mediaState, flush) {
  ...
  if (mediaState.performingUpdate) {
    ...
    mediaState.waitingToClearBuffer =
        flush ? shaka.media.StreamingEngine.ClearBufferType_.FLUSH :
                shaka.media.StreamingEngine.ClearBufferType_.NOFLUSH;
  } else {
      ...
      if (!this.mediaStates_[type]) {
        this.mediaStates_[type] = {
          ...
          waitingToClearBuffer:
              shaka.media.StreamingEngine.ClearBufferType_.NONE,
...
shaka.media.StreamingEngine.prototype.onUpdate_ = function(mediaState) {
  ...
  if (mediaState.waitingToClearBuffer) {
    ...
    this.clearBuffer_(mediaState,
        mediaState.waitingToClearBuffer ==
        shaka.media.StreamingEngine.ClearBufferType_.FLUSH);
    return;
  }
